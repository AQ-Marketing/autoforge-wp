...
function rocket_admin_bar( $wp_admin_bar ) {
	...
	// Boost: Sucuri cache-purge admin-bar item removed (Sucuri addon is gone).
	...
	// Boost: the external Documentation / FAQ / Support admin-bar links were
	// removed — they pointed at wp-rocket.me. The cache-purge items above are
	// the only Boost admin-bar entries.
}
