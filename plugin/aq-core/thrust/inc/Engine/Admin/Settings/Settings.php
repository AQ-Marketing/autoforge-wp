...
class Settings {
	...
	public function sanitize_callback( $input ) {
		...
		// Boost: Sucuri add-on removed (third-party firewall) — these options are
		// forced off and the API-key validation against the Sucuri class is dropped.
		$input['sucury_waf_cache_sync'] = 0;
