	...
	<div class="container-edge container-edge--wide py-14 grid gap-10 md:grid-cols-12">
		<div class="md:col-span-4">
			...
			<div class="flex gap-3 mt-5">
				<a href="<?php echo esc_url($f_social['facebook'] ?? '#'); ?>" class="w-9 h-9 rounded-full bg-black/30 hover:bg-[#f9ab3d] transition flex items-center justify-center text-white no-underline" aria-label="Facebook">
				...
				<a href="<?php echo esc_url($f_social['instagram'] ?? '#'); ?>" class="w-9 h-9 rounded-full bg-black/30 hover:bg-[#f9ab3d] transition flex items-center justify-center text-white no-underline" aria-label="Instagram">
		...
		<div class="md:col-span-2">
			<p class="font-semibold text-[#f9ab3d] mb-4 uppercase text-sm tracking-wider"><?php echo esc_html($f_company['heading'] ?? 'Company'); ?></p>
		...
		<div class="md:col-span-3">
			<p class="font-semibold text-[#f9ab3d] mb-4 uppercase text-sm tracking-wider"><?php echo esc_html($f_inspections['heading'] ?? 'Inspections'); ?></p>
		...
		<div class="md:col-span-3">
			<p class="font-semibold text-[#f9ab3d] mb-4 uppercase text-sm tracking-wider">Contact Us</p>
			...
			<div class="mt-5 flex flex-col gap-3 max-w-[260px]">
				...
				<a href="tel:<?php echo esc_attr($phone_tel); ?>" class="block py-3 px-6 text-xs uppercase tracking-wider text-center text-white font-semibold no-underline border border-white/30 rounded hover:bg-[#f9ab3d] hover:border-[#f9ab3d] transition">Call <?php echo esc_html($phone); ?></a>
			</div>
		</div>
	</div>
