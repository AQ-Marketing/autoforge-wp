...
<section>
  <div class="wrap">
    ...
    <div class="<?php echo esc_attr($s['container'] ?? 'grid-3'); ?>">
      ...
      <div class="card"><div class="ico"><i class="fa-solid <?php echo esc_attr($card['fa'] ?? ''); ?>"></i></div><h3><?php echo esc_html($card['title'] ?? ''); ?></h3><p><?php echo wp_kses_post($card['body'] ?? ''); ?></p></div>
      <?php endforeach; ?>
    </div>
  </div>
</section>
