...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function isOnDashboard() {
    ...
    return urlParams.get('page') === 'boost' && window.location.hash === '#dashboard';
  }
  function isOnRocketInsights() {
    const urlParams = new URLSearchParams(window.location.search);
    return urlParams.get('page') === 'boost' && window.location.hash === '#rocket_insights';
  }
  ...
  function isValidPageForPolling() {
    const urlParams = new URLSearchParams(window.location.search);
    return 'boost' === urlParams.get('page');
  }
...
class RocketMixpanel {
  ...
  _sendPageViewedEvent(source, newHash) {
    mixpanel.track('Page Viewed', {
      path: `/wp-admin/options-general.php?page=boost#${newHash}`,
