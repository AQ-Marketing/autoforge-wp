...
class Page extends Abstract_Render {
	...
	public function render_page() {
		// Boost: no license tab, no SaaS tabs (Rocket Insights, CDN), no third-party
		// service tabs (Add-ons, Cloudflare, Sucuri) — everything listed here works
		// fully self-contained on Pressable.
	...
	private function dashboard_section() {
		$this->settings->add_page_section(
			...
			[
				...
				'menu_description'        => __( 'Status & cache purge', 'rocket' ),
				'faq'                     => $this->beacon->get_suggest( 'faq' ),
				'customer_data'           => $this->customer_data(),
				'rocket_insights_enabled' => false,
				'is_rocketcdn_paid_user'  => false,
			]
		);
	}
